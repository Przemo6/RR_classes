...
load("Data/season_3.RData")
load("Data/season_4.RData")
load("Data/season_5.RData")
load("Data/season_6.RData")
load("Data/season_7.RData")
load("Data/season_8.RData")
...
Season `r params$season` of Game of Thrones consisted of 10 episodes that aired between April 17 and June 19, 2011 on HBO. The show gathered an average of 312313 first-day TV viewers in the US, with the number growing from 2131 to 12313131 million by the end of the season.
