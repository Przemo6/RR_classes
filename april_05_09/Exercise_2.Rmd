...
Season 1 of Game of Thrones consisted of `r params$data$no_season[-1]` episodes that aired between April 17 and June 19, 2011 on HBO. The show gathered an average of `r avg(params$data$viewers)` first-day TV viewers in the US, with the number growing from `r params$data$viewers[1]` to `r params$data$viewers[-1]` million by the end of the season.
